...
# =========================================================
# TELEGRAM DESKTOP - OFFICIAL CURRENT LINUX x64
# =========================================================
...
# =========================================================
# TIGERVNC XFCE STARTUP
# =========================================================

RUN mkdir -p /etc/vnc && \
    cat > /etc/vnc/xstartup <<'EOF'
#!/bin/sh
