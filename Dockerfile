...
RUN printf '%s\n' \
    ...
    'chown -R "$RDP_USER:$RDP_USER" "$USER_HOME/Pictures"' \
    \
    ...
    2>/dev/null || true' \
    \
    'echo "Disabling desktop notifications..."' \
    \
    'su - "$RDP_USER" -c \
    ...
    "$WALLPAPER_URL" \
    -o "$USER_HOME/Pictures/kali-wallpaper.jpg" || true' \
    'fi' \
    \
    ...
    -s \"$USER_HOME/Pictures/kali-wallpaper.jpg\"" \
    2>/dev/null || true' \
    \
    '    su - "$RDP_USER" -c \
    "xfconf-query -c xfce4-desktop \
    -p /backdrop/screen0/monitor0/image-style -s 5" \
    2>/dev/null || true' \
    'fi' \
    \
    ...
    -xstartup /home/$RDP_USER/.vnc/xstartup"' \
    \
    'echo "========================================"' \
